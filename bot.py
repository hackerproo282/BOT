...
buyers  = [764514914156412968]  #          
admins  = [764514914156412968]  #   ID users            
owners  = [764514914156412968]  #          
methods = ['HTTP-FLOOD', 'HTTP-RAW', 'HTTP-RAND', 'HTTP-SOCKET','CLOUDFLARE','UAM-BYPASS','SLOW'] # Methods
year_now= datetime.datetime.now().strftime("%Y")     
token   = 'MTIyNzU3NzU4MDg1Nzg1MTkxNQ.GpgLZU.n8GoRifdT8KtcpRK_8K0yGAZ0RHma_5hUitajY' # paste your token here
